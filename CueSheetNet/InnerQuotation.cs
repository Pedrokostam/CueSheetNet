...
namespace CueSheetNet
{
    public record struct InnerQuotation
    {
        ...
        /// </summary>
        public static InnerQuotation Apostrophes = new InnerQuotation('\'', '\'');
        /// <summary>
        /// Quotation marks consisting of two asymmentrical double quotes, both at the top. Commonly used in English. “Example”.
        /// </summary>
        public static InnerQuotation CurvedDoubleTopQuotation = new InnerQuotation(DefaultOpening, DefaultClosing);
        /// <summary>
        ...
        /// </summary>
        public static InnerQuotation CommaLikeBottomTopQuotation = new InnerQuotation('„', '”');
        /// <summary>
        /// Quotation marks consisting of two asymmentrical double angle marks. Also known as guillemets. «Example».
        /// </summary>
        public static InnerQuotation DoubleAngleQuotation = new InnerQuotation('«', '»');
        /// <summary>
        ...
        public InnerQuotation(char openingQuote1, char closingQuote1) : this()
        {
            OpeningQuote = openingQuote1;
            ClosingQuote = closingQuote1;
        }
